...
const BackIcon: FC<BackIconProps> = ({ className, isActive = false }) => {
    return (
        <svg
            className={className}
            version="1.1"
